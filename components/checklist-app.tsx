...
export function ChecklistApp() {
  ...
  const categories = [
    ...new Set(activeChecklists.map((item) => item.category)),
  ];
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Complete project management with templates and analytics
            </p>
          </div>
                ...
                <Card>
                  <CardContent className="text-center py-8">
                    <p className="text-gray-500">
                      No tasks found. Add a new task or create one from a
                      template.
                    </p>
                  </CardContent>
                </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">
                    Configure notifications, themes, and workspace preferences.
                  </p>
                </div>
              </CardContent>
            </Card>
